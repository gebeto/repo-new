...
export type SiteSiteMetadata = {
  ...
  social?: Maybe<Social>;
  repo?: Maybe<SiteSiteMetadataRepo>;
};

export type SiteSiteMetadataRepo = {
...
export type Dpkg = Node & {
  ...
  Name?: Maybe<Scalars['String']>;
  Pre_Depends?: Maybe<Scalars['String']>;
  Depends?: Maybe<Scalars['String']>;
  Conflicts?: Maybe<Scalars['String']>;
  Replaces?: Maybe<Scalars['String']>;
  Priority?: Maybe<Scalars['String']>;
  Depiction?: Maybe<Scalars['String']>;
  Sponsor?: Maybe<Scalars['String']>;
  Installed_Size?: Maybe<Scalars['String']>;
  gatsbyPath?: Maybe<Scalars['String']>;
};


export type DpkgGatsbyPathArgs = {
...
export type QueryDpkgArgs = {
  id?: InputMaybe<StringQueryOperatorInput>;
  parent?: InputMaybe<NodeFilterInput>;
  children?: InputMaybe<NodeFilterListInput>;
  internal?: InputMaybe<InternalFilterInput>;
  Package?: InputMaybe<StringQueryOperatorInput>;
  Version?: InputMaybe<StringQueryOperatorInput>;
  Architecture?: InputMaybe<StringQueryOperatorInput>;
  Maintainer?: InputMaybe<StringQueryOperatorInput>;
  Filename?: InputMaybe<StringQueryOperatorInput>;
  Size?: InputMaybe<StringQueryOperatorInput>;
  MD5sum?: InputMaybe<StringQueryOperatorInput>;
  SHA1?: InputMaybe<StringQueryOperatorInput>;
  SHA256?: InputMaybe<StringQueryOperatorInput>;
  Section?: InputMaybe<StringQueryOperatorInput>;
  Description?: InputMaybe<StringQueryOperatorInput>;
  Author?: InputMaybe<StringQueryOperatorInput>;
  Name?: InputMaybe<StringQueryOperatorInput>;
  Pre_Depends?: InputMaybe<StringQueryOperatorInput>;
  Depends?: InputMaybe<StringQueryOperatorInput>;
  Conflicts?: InputMaybe<StringQueryOperatorInput>;
  Replaces?: InputMaybe<StringQueryOperatorInput>;
  Priority?: InputMaybe<StringQueryOperatorInput>;
  Depiction?: InputMaybe<StringQueryOperatorInput>;
  Sponsor?: InputMaybe<StringQueryOperatorInput>;
  Installed_Size?: InputMaybe<StringQueryOperatorInput>;
  gatsbyPath?: InputMaybe<StringQueryOperatorInput>;
};


export type QueryAllDpkgArgs = {
  filter?: InputMaybe<DpkgFilterInput>;
  sort?: InputMaybe<DpkgSortInput>;
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  repo?: InputMaybe<SiteSiteMetadataRepoFilterInput>;
};
...
export type SiteSiteMetadataRepoFilterInput = {
  name?: InputMaybe<StringQueryOperatorInput>;
  description?: InputMaybe<StringQueryOperatorInput>;
};
...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___repo___name'
  | 'siteMetadata___repo___description'
  | 'pathPrefix'
  | 'polyfill'
  | 'jsxRuntime'
  | 'trailingSlash'
...
export type DpkgConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DpkgEdge>;
  nodes: Array<Dpkg>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  max?: Maybe<Scalars['Float']>;
  min?: Maybe<Scalars['Float']>;
  sum?: Maybe<Scalars['Float']>;
  group: Array<DpkgGroupConnection>;
};


export type DpkgConnectionDistinctArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgConnectionMaxArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgConnectionMinArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgConnectionSumArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgConnectionGroupArgs = {
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
  field: DpkgFieldsEnum;
};

export type DpkgEdge = {
  next?: Maybe<Dpkg>;
  node: Dpkg;
  previous?: Maybe<Dpkg>;
};

export type DpkgFieldsEnum =
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
...
export type DpkgGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DpkgEdge>;
  nodes: Array<Dpkg>;
  pageInfo: PageInfo;
...
export type DpkgGroupConnectionDistinctArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgGroupConnectionMaxArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgGroupConnectionMinArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgGroupConnectionSumArgs = {
  field: DpkgFieldsEnum;
};


export type DpkgGroupConnectionGroupArgs = {
  skip?: InputMaybe<Scalars['Int']>;
  limit?: InputMaybe<Scalars['Int']>;
  field: DpkgFieldsEnum;
};

export type DpkgFilterInput = {
  id?: InputMaybe<StringQueryOperatorInput>;
  parent?: InputMaybe<NodeFilterInput>;
  children?: InputMaybe<NodeFilterListInput>;
  internal?: InputMaybe<InternalFilterInput>;
...
export type DpkgSortInput = {
  fields?: InputMaybe<Array<InputMaybe<DpkgFieldsEnum>>>;
  order?: InputMaybe<Array<InputMaybe<SortOrderEnum>>>;
};
...
export type Unnamed_2_Query = { site?: { siteMetadata?: { title?: string | null } | null } | null, allDpkg: { nodes: Array<{ id: string, Name?: string | null, Section?: string | null, Filename?: string | null, Package?: string | null, Version?: string | null, Description?: string | null }>, group: Array<{ fieldValue?: string | null, nodes: Array<{ id: string, Name?: string | null, Section?: string | null, Filename?: string | null, Package?: string | null, Version?: string | null, Description?: string | null }> }> } };

export type DpkgQueryVariables = Exact<{
  id?: InputMaybe<Scalars['String']>;
}>;


export type DpkgQuery = { dpkg?: { id: string, Name?: string | null, Package?: string | null, Version?: string | null, Section?: string | null, Description?: string | null, Filename?: string | null } | null };
